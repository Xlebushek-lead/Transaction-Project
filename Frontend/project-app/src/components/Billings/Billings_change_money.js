    ...
    return (
        <div className="Billings_change_money-container">
            <div className='Billings_change_money-info__block'>
                ...
                <div className='Billings_change_money-balance'>{IntValue}</div> {/* Відображення введеного значення */}
                ...
                <div className='Billings_change_money-block'>
                    <div className='Billings_change_money-money'>
                        <input className='Billings_change_money-change' type='text' onChange={handleChange}  value={IntValue}/> 
                    </div>
                </div>
